...
# 后台IP设置
export Ipv4_ipaddr="192.168.88.2"            # 修改openwrt后台地址(填0为关闭)
...
# 旁路由选项
export Gateway_Settings="192.168.88.2"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
...
x86-64-generic-squashfs-rootfs.img.gz
